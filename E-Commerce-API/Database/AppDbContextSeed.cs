    ...
    public class AppDbContextSeed
    {
        public static async Task SeedAsync(AppDbContext context, ILoggerFactory loggerFactory)
        {
            try
            {
                ...
                {
                    var brandsData = File.ReadAllText(@"Database/SeedData/brands.json");
                ...
                {
                    var typesData = File.ReadAllText(@"Database/SeedData/types.json");
                ...
                {
                    var productsData = File.ReadAllText(@"Database/SeedData/products.json");
